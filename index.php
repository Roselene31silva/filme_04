...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-6 align-content-center">
            <p>"Em Thunderbolts, a Marvel Studios reuniu uma equipe não convencional de anti-heróis – Yelena Belova,
                Bucky Barnes, Guardião Vermelho, Fantasma, Treinador e John Walker. Presos em uma armadilha mortal, sete
                párias desiludidos são forçados a embarcar em uma missão perigosa que os obrigará a confrontar os cantos
                mais sombrios de seus passados".</p>
    ...
    <div class="row">
        <div class="col-6 align-content-center">
            <p>O filme Hereditário (2018) conta a história da família Graham, que lida com a morte de sua matriarca,
                Ellen. Após sua morte, Annie (Toni Collette), seu marido e filhos começam a desvendar segredos
                perturbadores sobre sua ancestralidade e enfrentam eventos sobrenaturais que ameaçam sua sanidade e
                união familiar. O filme explora temas de luto, trauma e a inevitabilidade do destino.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>E-mail: filme@filme.com.br <br> Whatsapp: (11)99999-9999 <br><a href="contato.php">Formulário de
                            conato</a></p>
                </div>
            </div>
        </div>
